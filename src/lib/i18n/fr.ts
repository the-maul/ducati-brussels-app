...
export const fr = {
  ...
  signup: {
    ...
    kioskPasswordNote: 'Pour votre sécurité, aucun mot de passe n’est saisi sur cette tablette : vous le choisirez depuis l’e-mail que vous allez recevoir.',
    interest: {
      neuf: 'Une moto neuve',
    ...
    welcomeInvite: 'Un e-mail vient d’être envoyé à {email} pour choisir votre mot de passe.',
    welcomeConfirmEmail: 'Pour protéger vos données, un e-mail vient d’être envoyé à {email} : choisissez votre mot de passe depuis ce message pour activer votre compte.',
