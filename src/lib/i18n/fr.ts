...
export const fr = {
  ...
  contacts: {
    ...
    bulkMainHintMerge: 'Les autres fiches seront fusionnées dedans puis archivées. Leurs documents, véhicules et historiques sont réassignés à la fiche principale.',
    ...
    bulkMergeFailed: '{n} fiche(s) en échec.',
    bulkMergeTableIssues: 'Tables non réassignées : {tables}.',
    // erreurs
    errLoad: 'Chargement impossible.',
    errSave: 'Enregistrement impossible.',
