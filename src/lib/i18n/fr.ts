...
export const fr = {
  ...
  orders: {
    ...
    excelSubtitle: 'Chargez les pièces par onglet (Demo/Courtoisie/Showroom). Seuil 2 000 € HTVA par onglet. Téléchargez le classeur prérempli, puis clôturez-le pour l’archiver.',
