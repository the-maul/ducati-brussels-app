...
export const fr = {
  ...
  vehicles: {
    ...
    ducatiNoData: 'Aucune donnée My Ducati. Importez-la via l’extension (bouton sur la fiche moto du portail Ducati).',
  ...
  contacts: {
    ...
    // Type d'entreprise (B2B) — forme juridique belge, libellés FR / NL
    companyType: 'Type d’entreprise',
    companyTypePlaceholder: 'Sélectionner…',
    ctype_srl: 'SRL / BV — Société à resp. limitée',
    ctype_sa: 'SA / NV — Société anonyme',
    ctype_sc: 'SC / CV — Société coopérative',
    ctype_scomm: 'SComm / CommV — Société en commandite',
    ctype_snc: 'SNC / VOF — Société en nom collectif',
    ctype_asbl: 'ASBL / VZW — Association sans but lucratif',
    ctype_indep: 'Indépendant / Eenmanszaak',
    ctype_sprl: 'SPRL / BVBA (ancienne forme)',
    ctype_autre: 'Autre / Andere',
    email: 'E-mail',
    phone: 'Téléphone',
    mobile: 'Mobile',
    // adresse
