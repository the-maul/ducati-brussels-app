...
| 4 | **Borne comptoir** (tablette) + encodage manuel + page d'inscription intégrable au site | Un client s'enregistre seul à la tablette et reçoit le message de bienvenue | ⬜ | — |
| 5 | Finitions : questionnaire du site dans le même tuyau, tri G8 (4 165 contacts facturés → client), notification d'inscription | Les trois points faits | 🟦 notification d'inscription faite (cloche) | 18/09 |
