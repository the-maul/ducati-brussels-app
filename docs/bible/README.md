...
| 02 | [Commandes de pièces](missions/mission-02-commandes-pieces.md) ([spécification](../process-commandes-pieces.md)) | 🟦 règles des 4 types, suivi de l’état et pièces d’une commande faits (à valider) · réservation en PDF par mail faite (à valider) · paiement par QR de virement sur le 2e écran fait (à valider ; Stripe et Bancontact à venir) · reste 5 cartes |
...
| 05 | [Devis moto, options et préparation](missions/mission-05-devis-preparation.md) | 🟦 feu vert 19/09 · cartes 1 à 9 faites (à valider) · reste 10 |
