...
| 03 | [Shopify](missions/mission-03-shopify.md) | 🟦 accès fait · produits Shopify rapprochés des articles (à valider) · photos et textes repris dans le DMS (à valider) · commandes du site → facture et sortie de stock (à valider, import livré Arrêté) · questions en attente |
...
| 07 | [Plan d'entretien](missions/mission-07-plan-entretien.md) | 🟦 carte 1 faite le 21/09 (59 plans) · carte 3 faite le 23/09, à valider : manuels d'atelier **chargés en production** (461 manuels, 469 modèles-années, 3 336 procédures) ; 2 migrations de finition à appliquer, écran parcours technicien à brancher (`lot-manuels-branchement`) |
