...
| # | Mission | État |
|---|---|---|
| 01 | [Nouveau client](missions/mission-01-nouveau-client.md) | 🟦 lots 0, 1, 2 faits · lot 5 : cloche des inscriptions et tri G8 faits · retour du 21/09 sur l’inscription (e-mail dans le GSM, téléphones uniformisés, permis recto/verso, profil en %) fait (à valider) · téléphone de la carte CRM sans e-mail et signature des e-mails selon l’adresse d’envoi faits (à valider) · reste fusion des doublons, portail, borne, questionnaire du site |
| 02 | [Commandes de pièces](missions/mission-02-commandes-pieces.md) ([spécification](../process-commandes-pieces.md)) | 🟦 règles des 4 types, suivi de l’état et pièces d’une commande faits (à valider) · réservation en PDF par mail faite (à valider) · paiement par QR de virement sur le 2e écran fait (à valider ; Stripe et Bancontact à venir) · commande depuis un devis ou une facture faite (à valider) · regroupement par fournisseur et commande fournisseur faits (à valider ; fichier DCS exact attendu) · gestion des listes de préparation (« picking list ») faite (à valider) · reste 3 cartes |
| 03 | [Shopify](missions/mission-03-shopify.md) | 🟦 accès fait · produits Shopify rapprochés des articles (à valider ; depuis M-25 chaque produit du site est un article du DMS, stock de départ = stock du site) · photos et textes repris dans le DMS (à valider) · commandes du site → facture et sortie de stock (à valider, import livré Arrêté) · questions en attente  · **motos à vendre : du stock du DMS au site fait le 23/09 (à valider)** : 68 articles de moto créés, 30 motos du site rattachées, 458 à valider, migrations `20260923150000` + `20260923151000` appliquées · **rapprochement purifié le 23/09 (à valider) : 10 251 « à valider » → 2, la machine tranche seule (M-40 à M-43, migrations `20260923140000`…`142000` appliquées)**|
| 03 | [Shopify](missions/mission-03-shopify.md) | 🟦 accès fait · produits Shopify rapprochés des articles (à valider ; depuis M-25 chaque produit du site est un article du DMS, stock de départ = stock du site) · photos et textes repris dans le DMS (à valider) · commandes du site → facture et sortie de stock (à valider, import livré Arrêté) · questions en attente  · **motos à vendre : du stock du DMS au site fait le 23/09 (à valider)** : 99 motos du parc ont leur article, les 25 motos en ligne sans fiche créées automatiquement (VIN à compléter, vente bloquée sans VIN), **0 proposition à valider**, migrations `20260923150000`, `20260923151000` et `20260923180000` appliquées|
