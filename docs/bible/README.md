...
| # | Mission | État |
|---|---|---|
| 01 | [Nouveau client](missions/mission-01-nouveau-client.md) | 🟦 lots 0, 1, 2 faits · reste fusion des doublons, portail, borne |
| 02 | Commandes de pièces ([spécification](../process-commandes-pieces.md)) | ⬜ |
...
1. **Sécurité — accès sans connexion.** Une centaine de fonctions de la base sont appelables avec la
   ...
   Correctif proposé : [`00-architecture.md`](00-architecture.md) §9. *M00, M12, architecture.*
