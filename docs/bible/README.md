...
| # | Mission | État |
|---|---|---|
| 01 | [Nouveau client](missions/mission-01-nouveau-client.md) | 🟦 lots 0, 1, 2 faits · lot 5 : cloche des inscriptions et tri G8 faits · retour du 21/09 sur l’inscription (e-mail dans le GSM, téléphones uniformisés, permis recto/verso, profil en %) fait (à valider) · reste fusion des doublons, portail, borne, questionnaire du site |
