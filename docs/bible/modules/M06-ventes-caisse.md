...
- **« En commande » d'une commande de pièces jamais soldé** : une commande de pièces reste comptée « en commande » tant qu'elle n'est pas annulée (il n'existe pas d'état « reçue » ; la réception sera reliée avec la carte 4 de la mission 02). Quand une commande de pièces deviendra une CMD fournisseur (carte 4), il faudra l'exclure du calcul pour ne pas la compter deux fois.
