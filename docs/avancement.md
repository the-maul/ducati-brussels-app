...
| E1 — Contacts + Articles (M1, M2) | M1 fiche client **parité G8** ✅ · M2 articles **parité G8** (types A–R+**T**, prix/PAMP/PVHT/DEEE, multi-casier, comptes, reprise, kits) ✅ CRUD · reste : moteur d'import tarifs + équivalences/codes-barres UI | 🟦 en cours |
| E2 — Véhicules (M3) | — | ⬜ |
